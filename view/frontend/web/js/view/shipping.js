...
define([
    ...
    return Component.extend({
        defaults: {
            ...
            shippingMethodListTemplate: 'Aimsinfosoft_InsuranceFees/shipping-address/shipping-method-list',
        ...
        getconfigValue: function () {
            var serviceUrl = url.build('insurancesfees/custom/enable');
        ...
        getShippingconfigValue: function () {
            var serviceUrl = url.build('insurancesfees/custom/shippinglayoutenable');
